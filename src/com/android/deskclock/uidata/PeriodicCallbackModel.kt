...
internal class PeriodicCallbackModel(context: Context) {
     ...
     */
    fun addQuarterHourCallback(runnable: Runnable, offset: Long) {
     ...
     */
    fun addHourCallback(runnable: Runnable, offset: Long) {
     ...
     */
    fun addMidnightCallback(runnable: Runnable, offset: Long) {
