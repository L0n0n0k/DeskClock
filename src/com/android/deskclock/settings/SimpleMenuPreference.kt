...
class SimpleMenuPreference(context: Context?, attrs: AttributeSet?, defStyleAttr: Int,
    ...
    companion object {
        private fun restoreOriginalOrder(array: Array<CharSequence>,
        ...
        private fun setSelectedPosition(array: Array<CharSequence>,
                                        lastSelectedOriginalPosition: Int, position: Int) {
            val item = array[position]
