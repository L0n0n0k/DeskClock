...
class SimpleMenuPreference(context: Context?, attrs: AttributeSet?, defStyleAttr: Int,
                           defStyleRes: Int) : DropDownPreference(context, attrs, defStyleAttr, defStyleRes) {
    private lateinit var mAdapter: SimpleMenuAdapter

    constructor(context: Context?) : this(context, null) {}

    constructor(context: Context?, attrs: AttributeSet?) : this(context, attrs, R.attr.dropdownPreferenceStyle) {}
    ...
    private class SimpleMenuAdapter internal constructor(context: Context, resource: Int) : ArrayAdapter<CharSequence?>(context, resource) {
    ...
    companion object {
        private fun restoreOriginalOrder(array: Array<CharSequence>, lastSelectedOriginalPosition: Int) {
            val item = array[0]
        ...
        private fun setSelectedPosition(array: Array<CharSequence>, lastSelectedOriginalPosition: Int, position: Int) {
            val item = array[position]
