...
class SettingsActivity : BaseActivity() {
    ...
    class PrefsFragment : PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        override fun onPreferenceChange(pref: Preference, newValue: Any): Boolean {
            when (pref.getKey()) {
                ...
                KEY_CLOCK_DISPLAY_SECONDS -> DataModel.getDataModel().displayClockSeconds = newValue as Boolean
                KEY_AUTO_SILENCE -> {
        ...
        private fun showDialog(fragment: PreferenceDialogFragmentCompat) {
            // TODO(colinmarsch) Replace deprecated getFragmentManager calls with AndroidX equivalent
        ...
        private fun refresh() {
            ...
            val autoHomeClockEnabled: Boolean = (autoHomeClockPref as TwoStatePreference).isChecked()
