...
class AlarmVolumePreference(context: Context?, attrs: AttributeSet?) : Preference(context, attrs) {
        ...
        mSeekbar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            ...
            override fun onStopTrackingTouch(seekBar: SeekBar) {
                if (!mPreviewPlaying && seekBar.getProgress() != 0) {
                    ...
                    RingtonePreviewKlaxon.start(context, DataModel.getDataModel().defaultAlarmRingtoneUri)
    ...
    private fun onSeekbarChanged() {
        ...
        mAlarmIcon.setImageResource(if (mSeekbar.getProgress() == 0) R.drawable.ic_alarm_off_24dp else R.drawable.ic_alarm_small)
    }
    ...
    private fun doesDoNotDisturbAllowAlarmPlaybackNPlus(): Boolean {
        val notificationManager: NotificationManager = getContext().getSystemService(NOTIFICATION_SERVICE) as NotificationManager
