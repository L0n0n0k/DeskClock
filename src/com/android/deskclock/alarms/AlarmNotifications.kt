...
import com.android.deskclock.NotificationUtils.ALARM_MISSED_NOTIFICATION_CHANNEL_ID
import com.android.deskclock.NotificationUtils.ALARM_SNOOZE_NOTIFICATION_CHANNEL_ID
import com.android.deskclock.NotificationUtils.ALARM_UPCOMING_NOTIFICATION_CHANNEL_ID
import com.android.deskclock.NotificationUtils.FIRING_NOTIFICATION_CHANNEL_ID
...
internal object AlarmNotifications {
    ...
    fun showUpcomingNotification(
        ...
        if (lowPriority) {
            ...
            val hideIntent = AlarmStateManager.createStateChangeIntent(context,
    ...
    private fun updateUpcomingAlarmGroupNotification(
        ...
        if (summary == null ||
            ...
            NotificationUtils.createChannel(context, ALARM_UPCOMING_NOTIFICATION_CHANNEL_ID)
            summary = NotificationCompat.Builder(context, ALARM_UPCOMING_NOTIFICATION_CHANNEL_ID)
                    .setShowWhen(false)
    ...
    private fun updateMissedAlarmGroupNotification(
        ...
        if (summary == null ||
            ...
            summary = NotificationCompat.Builder(context, ALARM_MISSED_NOTIFICATION_CHANNEL_ID)
                    .setShowWhen(false)
