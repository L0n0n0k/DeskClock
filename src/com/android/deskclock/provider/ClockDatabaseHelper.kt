 ...
 */
class ClockDatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, VERSION_8) {
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, currentVersion: Int) {
        ...
        if (oldVersion <= VERSION_6) {
            ...
            val cursor: Cursor? = db.query(OLD_ALARMS_TABLE_NAME, OLD_TABLE_COLUMNS, null, null, null, null, null)
        ...
        try {
            ...
            if (value != null) {
                ...
                if (id > -1) {
                    ...
                    val cursor: Cursor = db.query(ALARMS_TABLE_NAME, columns, selection, selectionArgs, null, null, null)
