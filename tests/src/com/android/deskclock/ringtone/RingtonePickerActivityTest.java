...
public class RingtonePickerActivityTest {
    ...
    public void validateDefaultState_TimerRingtonePicker() {
        ...
        if (systemRingtoneHolders != null) {
            ...
            assertEquals(HeaderViewHolder.VIEW_TYPE_ITEM_HEADER,
                         filesHeaderHolder.getItemViewType());

            final AddCustomRingtoneHolder addNewHolder = (AddCustomRingtoneHolder) itemsIter.next();
            assertEquals(AddCustomRingtoneViewHolder.VIEW_TYPE_ADD_NEW,
                         addNewHolder.getItemViewType());
            ...
            assertEquals(HeaderViewHolder.VIEW_TYPE_ITEM_HEADER,
                         systemHeaderHolder.getItemViewType());
            ...
            assertEquals(RingtoneViewHolder.VIEW_TYPE_SYSTEM_SOUND,
                         defaultHolder.getItemViewType());
