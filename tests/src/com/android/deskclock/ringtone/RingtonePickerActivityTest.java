...
public class RingtonePickerActivityTest {
  ...
  @Rule
  public ActivityTestRule<RingtonePickerActivity> rule  = new  ActivityTestRule<>(RingtonePickerActivity.class, true, false);
  ...
  public void validateDefaultState_AlarmRingtonePicker() {
    ...
    Runnable assertRunnable = () -> {
      ...
      assertEquals(DataModel.getDataModel().getDefaultAlarmRingtoneUri(), defaultHolder.getUri());
    };
    InstrumentationRegistry.getInstrumentation().runOnMainSync(assertRunnable);
  }
  ...
  public void validateDefaultState_TimerRingtonePicker_WithCustomRingtones() {
    ...
    assertEquals(RingtoneViewHolder.VIEW_TYPE_CUSTOM_SOUND, customRingtoneHolder.getItemViewType());
